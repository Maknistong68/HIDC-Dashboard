  ...
  return (
    <div className="space-y-6">
            ...
            >
              <div className="flex items-start justify-between gap-4">
                <div className="flex-1">
                  ...
                  <p className="text-sm text-surface-500 mt-1">{field.description}</p>

                  {previewValue && (
                    <p className="text-sm mt-2">
                      <span className="text-surface-500">Preview: </span>
                      <span className="text-surface-700 font-mono bg-surface-100 px-2 py-0.5 rounded">
                ...
                <div className="w-64">
                  <select
                    ...
                    className="w-full px-3 py-2 border border-surface-200 rounded-lg focus:ring-2 focus:ring-primary-500 focus:border-primary-500 outline-none text-sm"
                  >
      ...
      {previewData && previewData.length > 0 && (
        <div className="mt-6">
          <h4 className="font-medium text-surface-900 mb-3">Data Preview (First 3 rows)</h4>
            ...
            <table className="w-full text-sm">
              ...
              <tbody>
                {previewData.slice(0, 3).map((row, rowIndex) => (
                  <tr key={rowIndex} className="border-t border-surface-200">
                    {headers.map((_, colIndex) => (
                      <td key={colIndex} className="px-3 py-2 whitespace-nowrap text-surface-700">
