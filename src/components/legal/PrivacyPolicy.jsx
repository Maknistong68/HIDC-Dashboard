...
const PrivacyPolicy = () => {
  return (
    <div className="prose prose-sm max-w-none">
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-surface-900 mb-3">2. Data We Collect</h3>
        <p className="text-surface-600 mb-3">The application collects and stores the following types of data:</p>
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-surface-900 mb-3">3. How Data Is Stored</h3>
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-surface-900 mb-3">4. Data Transmission</h3>
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-surface-900 mb-3">5. Data Access</h3>
        <p className="text-surface-600 mb-3">Your data can only be accessed by:</p>
        <ul className="list-disc pl-6 text-surface-600 space-y-2">
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-surface-900 mb-3">7. Your Rights</h3>
        <p className="text-surface-600 mb-3">You have full control over your data:</p>
        <ul className="list-disc pl-6 text-surface-600 space-y-2">
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-surface-900 mb-3">9. Cookies and Tracking</h3>
        <p className="text-surface-600">
