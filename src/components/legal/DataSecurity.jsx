...
const DataSecurity = () => {
  return (
    <div className="prose prose-sm max-w-none">
      <p className="text-sm text-gray-500 mb-6">Technical Documentation for IT & Management Review</p>
      ...
      <section className="mb-8">
        ...
        <div className="grid gap-3">
          <div className="bg-gray-50 rounded-lg p-3 flex items-start gap-3">
            ...
            <div>
              <p className="font-medium text-gray-800">Device-Only Storage</p>
              <p className="text-sm text-gray-600">Data exists only on YOUR computer/device, not on any server</p>
            </div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 flex items-start gap-3">
            <Lock className="w-5 h-5 text-gray-600 flex-shrink-0 mt-0.5" />
            <div>
              <p className="font-medium text-gray-800">Browser-Isolated</p>
              <p className="text-sm text-gray-600">Each browser has separate storage - Chrome data isn't visible in Firefox</p>
            </div>
          </div>
          <div className="bg-gray-50 rounded-lg p-3 flex items-start gap-3">
            <WifiOff className="w-5 h-5 text-gray-600 flex-shrink-0 mt-0.5" />
            <div>
              <p className="font-medium text-gray-800">Works Offline</p>
              <p className="text-sm text-gray-600">Data is accessible even without internet connection</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mb-8">
        ...
        <div className="border border-gray-200 rounded-lg overflow-hidden">
          <div className="bg-gray-100 px-3 py-2 border-b border-gray-200">
            <p className="text-xs font-mono text-gray-600">Developer Tools → Network Tab</p>
          </div>
          <div className="p-4 bg-gray-900 text-green-400 font-mono text-sm">
            <p className="mb-2"># What you should see:</p>
            <p className="text-gray-500">- Initial page load files (JS, CSS) ✓</p>
            <p className="text-gray-500">- Local file operations only ✓</p>
            <p className="mb-2"></p>
      ...
      <section className="mb-8">
        ...
        <div className="border border-gray-200 rounded-lg overflow-hidden">
          <div className="bg-gray-100 px-3 py-2 border-b border-gray-200">
            <p className="text-xs font-mono text-gray-600">Developer Tools → Application → Local Storage</p>
          </div>
            ...
            <table className="w-full">
              ...
              <tbody className="text-green-400">
                <tr>
                  ...
                  <td className="text-gray-400">Your observation records</td>
                </tr>
                <tr>
                  <td className="py-1">hidc_projects</td>
                  <td className="text-gray-400">Project information</td>
                </tr>
                <tr>
                  <td className="py-1">hidc_settings</td>
                  <td className="text-gray-400">App preferences</td>
                </tr>
              </tbody>
            </table>
          </div>
        ...
        <div className="border border-gray-200 rounded-lg overflow-hidden">
          <table className="w-full text-sm">
            <thead className="bg-gray-50">
              <tr>
                <th className="px-4 py-2 text-left text-gray-600">Check</th>
                <th className="px-4 py-2 text-left text-gray-600">Result</th>
            ...
            <tbody>
              <tr className="border-t border-gray-200">
                ...
                <td className="px-4 py-2 text-gray-500">None found</td>
                <td className="px-4 py-2 text-green-600 font-medium">✓ PASS</td>
              </tr>
              <tr className="border-t border-gray-200">
                <td className="px-4 py-2">axios HTTP library</td>
                <td className="px-4 py-2 text-gray-500">Not installed</td>
                <td className="px-4 py-2 text-green-600 font-medium">✓ PASS</td>
              </tr>
              <tr className="border-t border-gray-200">
              ...
              <tr className="border-t border-gray-200">
                ...
                <td className="px-4 py-2 text-gray-500">None used</td>
                <td className="px-4 py-2 text-green-600 font-medium">✓ PASS</td>
              </tr>
              <tr className="border-t border-gray-200">
              ...
              <tr className="border-t border-gray-200 bg-green-50">
                ...
                <td className="px-4 py-2 text-gray-700">localStorage only</td>
      ...
      {/* For IT Department */}
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">For IT Department</h3>

        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <p className="text-gray-700 mb-3">To independently verify these claims, IT can:</p>
          <ol className="list-decimal pl-5 text-gray-600 space-y-2 text-sm">
            <li>Review the source code in the <code className="bg-gray-200 px-1 rounded">/src</code> directory</li>
            <li>Search for network-related keywords: <code className="bg-gray-200 px-1 rounded">fetch</code>, <code className="bg-gray-200 px-1 rounded">axios</code>, <code className="bg-gray-200 px-1 rounded">XMLHttpRequest</code></li>
            <li>Monitor network traffic using browser DevTools or Wireshark</li>
            <li>Check <code className="bg-gray-200 px-1 rounded">package.json</code> for dependencies - no backend/API libraries</li>
