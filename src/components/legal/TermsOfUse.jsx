  ...
  return (
    <div className="prose prose-sm max-w-none">
      ...
      <section className="mb-8">
        ...
        <p className="text-gray-600 mb-3">As a user of this application, you agree to:</p>
        <ul className="list-disc pl-6 text-gray-600 space-y-2">
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">5. Data Ownership</h3>
        <p className="text-gray-600">
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">6. No Warranty</h3>
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">8. Data Loss Disclaimer</h3>
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">9. Modifications to Terms</h3>
        <p className="text-gray-600">
      ...
      <section className="mb-8">
        <h3 className="text-lg font-semibold text-gray-900 mb-3">11. Severability</h3>
        <p className="text-gray-600">
