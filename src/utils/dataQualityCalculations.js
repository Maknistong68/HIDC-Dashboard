...
import { CONTEXT_REDIRECTS, HAZARD_PHRASES, HAZARD_PATTERNS, FOUL_WORDS_LIST, VAGUE_HAZARD_TERMS, RECORDABLE_INCIDENT_TYPES } from './constants'
...
export const getUnclassifiableRecords = (incidents) => {
  ...
  const allArrays = [noDescription, tooShort, unrecognizedCategory, lowConfidence, historicalPlaceholder]
